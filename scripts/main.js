...
// Отправка данных
  $(function ($) {
    $("#feed__back_send").click(function (e) {
        ...
        feedback__crypto = `The cost of your ${card__nick} in BTC: ${(card__price / priceBtc).toFixed(4)}, ETH: ${(card__price / priceEth).toFixed(4)}, ETC: ${(card__price / priceEtc).toFixed(4)}`;
        ...
        if (feedback__name && feedback__tel && feedback__tiker && feedback__words) {
          $.ajax({
